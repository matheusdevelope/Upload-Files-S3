...
var LOG = [
    {
        method: "post",
        route: "/api/log/get",
        controller: LogController_1.LogController,
        action: "all",
    },
    {
        method: "post",
...
exports.Routes = __spreadArray(__spreadArray(__spreadArray(__spreadArray([
    // {
    //   method: "get",
    //   route: "/",
...
], Manager, true), User, true), FTP, true), LOG, true);
